            ...
            <div class="card-body">
                <form action="{{ route('saveedit') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="plat" value="{{ $edit->plat }}" class="form-control" id="formGroupExampleInput" placeholder="Masukkan plat">
                        @error('plat')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nim" value="{{ $edit->nim}}" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Nomor Induk">
                        @error('nim')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="masaaktif" value="{{ $edit->masaaktif }}" class="form-control yearpicker" id="formGroupExampleInput" placeholder="YYYY" min="2024" max="2100">
                        @error('masaaktif')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
